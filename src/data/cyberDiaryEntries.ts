...
export const cyberDiaryEntries: DiaryEntry[] = [
  {
    ...
    body: [
      ...
      'Once everything passed, I asked for a second-pass security review on purpose, since this is a security-focused portfolio piece and "it passes" is not the same bar as "I can explain the trust model." The review confirmed the self-hosted agent has root-equivalent access to the mini PC (expected for any self-hosted runner, worth stating precisely rather than glossing over), confirmed the old SSH deploy key is fully revoked on both ends, and flagged checking whether the public repo requires my approval before a fork PR gets free compute.',
    ],
    screenshots: [
